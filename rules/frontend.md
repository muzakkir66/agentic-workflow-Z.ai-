...
|---|---|
| CSS | Tailwind, vanilla CSS, CSS Modules, styled-components, Emotion, UnoCSS |
| Primitives | shadcn/ui, Radix, Headless UI, DaisyUI, Mantine, Chakra |
| Animation | CSS transitions, Framer Motion, GSAP, View Transitions API |
| Charts | Recharts, D3, Chart.js, Visx, ECharts |
| Icons | Lucide, Phosphor, Heroicons, Tabler Icons |
